...
The `platform` component provides the platform infrastructure layer for the ecare project. It creates all application-level infrastructure including Kubernetes clusters, databases, storage, and monitoring.
...
- **State File**: `platform/terraform.tfstate`
