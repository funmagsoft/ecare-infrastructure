...
This document defines the naming conventions used in the `foundation` repository for Azure infrastructure resources (networking, VPN, GitHub OIDC integration).
...
- `repo:hycom/foundation:environment:dev`
- `repo:hycom/platform:environment:test`
- `repo:hycom/workload:environment:prod`
