...
> **Note**: This is part of the [ecare-infrastructure monorepo](../../README.md). All paths in this documentation are relative to the `foundation` directory unless otherwise specified.
...
- **Identity (workload)**: UAMI for service repos → Application deployment
