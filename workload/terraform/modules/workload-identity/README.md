...
- **platform AKS module:** Requires AKS OIDC issuer URL and namespace name from platform outputs
- **platform Key Vault module:** Uses Key Vault ID for RBAC role assignment
- **platform Storage module:** Uses Storage Account ID for RBAC role assignment
- **platform Service Bus module:** Uses Service Bus Namespace ID for RBAC role assignment
