...
This document defines the naming conventions used in the `infra-platform` repository for Azure platform services (AKS, ACR, PostgreSQL, Storage, Key Vault, Service Bus, Bastion, Monitoring).
...
- Created by `infra-identity` phase
